...
/*-----------------------------------------------------------測試功能-------------------------------------------------------*/
  ...
  //使用頁面 store_edit2 -  簡單版店家頁面 - store_edit2 - 目前可自動撈資料
...
//    
    ...
    public String updateStore(
       ...
       //放入所有類別 
        ...
        return "redirect:/front/store/store_edit2"; // 或你想回去的頁面
    }
...
//    }
    ...
    public String editStoreCoupon(Model model){
        ...
        return "front/store/store_coupon_prodphoto";
...
//    }
    ...
    public String showTaiStore2(Model model) {
    	...
    	System.out.println("✅ 撈到店家筆數：" + thaiStores.size());
        String[] weekdays = {"星期日","星期一","星期二","星期三","星期四","星期五","星期六"};
    	return "front/restaurant/thai-cuisine2"; //找 templates/thai-cuisine.html
    }
    
    @GetMapping("/test")
    public String testTemplate() {
        return "front/restaurant/thai-cuisine2";
    }
