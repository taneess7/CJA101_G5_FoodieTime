...
INSERT INTO COUPON (STOR_ID, COU_NAME, COU_TYPE, COU_DESC, COU_MIN_ORD, COU_DATE)
VALUES (1,'開幕500', '新開幕', '買500送500', 500, '2025-07-01 00:00:00'),
       (2,'生日送100', '生日券', '生日當月憑證折100元', 200, '2025-08-01 00:00:00'),
       (3,'會員95', '會員專屬', '會員限定95折', 0, '2025-06-20 00:00:00'),
       (4,'滿額折30', '滿額折扣', '滿300折30', 300, '2025-07-15 00:00:00'),
       (5,'半價優惠', '飲品半價', '指定飲品半價', 50, '2025-07-20 00:00:00'),
       (6,'第二件六折', '甜點優惠', '甜點第二件6折', 100, '2025-07-25 00:00:00'),
       (7,'外送200', '外送折扣', '外送滿200免運', 200, '2025-08-01 00:00:00'),
       (8,'就愛學生', '學生專屬', '學生證享9折', 0, '2025-08-10 00:00:00'),
       (9,'新折50', '新會員禮', '新會員首單折50', 0, '2025-08-15 00:00:00'),
       (10,'老送100', '老客戶回饋', '老客戶滿500折100', 500, '2025-08-20 00:00:00');
